//#region tests/real-world/vitest/mocker/automocker.d.ts
...
//#endregion
//#region tests/real-world/vitest/mocker/registry.d.ts
...
//#endregion
//#region tests/real-world/vitest/mocker/types.d.ts
...
//#endregion
export { AutomockedModule, type AutomockedModuleSerialized, AutospiedModule, type AutospiedModuleSerialized, type GlobalConstructors, ManualMockedModule, type ManualMockedModuleSerialized, type MockObjectOptions, type MockedModule, type MockedModuleSerialized, type MockedModuleType, MockerRegistry, type ModuleMockContext, type ModuleMockFactory, type ModuleMockFactoryWithHelper, type ModuleMockOptions, RedirectedModule, type RedirectedModuleSerialized, type ServerIdResolution, type ServerMockResolution, type TestModuleMocker, mockObject };