...
export interface InternalTestContext extends Record<'concurrent' | 'sequential' | 'skip' | 'only' | 'todo' | 'fails' | 'each', boolean | undefined> {
 ...
 */
export type ExtractScopedFixtures<T extends ScopedFixturesDef> = ([Exclude<T['$test'], undefined>] extends [never] ? object : Exclude<T['$test'], undefined>) & ([Exclude<T['$file'], undefined>] extends [never] ? object : Exclude<T['$file'], undefined>) & ([Exclude<T['$worker'], undefined>] extends [never] ? object : Exclude<T['$worker'], undefined>);
/**
...
export type ScopedFixturesObject<T extends ScopedFixturesDef, ExtraContext = object> = {
    [K in keyof NonNullable<T['$test']>]: NonNullable<T['$test']>[K] | ScopedFixtureFn<NonNullable<T['$test']>[K], ExtractScopedFixtures<T> & ExtraContext & TestContext> | [ScopedFixtureFn<NonNullable<T['$test']>[K], ExtractScopedFixtures<T> & ExtraContext & TestContext>, TestScopeFixtureOptions?];
} & {
