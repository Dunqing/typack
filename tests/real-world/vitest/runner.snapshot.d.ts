import { Awaitable, TestError } from "@vitest/utils";
import { DiffOptions } from "@vitest/utils/diff";

//#region tests/real-world/vitest/runner/types/runner.d.ts
/**
...
//#endregion
//#region tests/real-world/vitest/runner/fixture.d.ts
...
//#endregion
//#region tests/real-world/vitest/runner/hooks.d.ts
/**
...
//#endregion
//#region tests/real-world/vitest/runner/utils/chain.d.ts
...
//#endregion
//#region tests/real-world/vitest/runner/types/tasks.d.ts
...
//#endregion
//#region tests/real-world/vitest/runner/artifact.d.ts
/**
* @experimental
* @advanced
*
...
//#endregion
//#region tests/real-world/vitest/runner/map.d.ts
...
//#endregion
//#region tests/real-world/vitest/runner/run.d.ts
...
//#endregion
//#region tests/real-world/vitest/runner/suite.d.ts
/**
...
//#endregion
//#region tests/real-world/vitest/runner/test-state.d.ts
declare function getCurrentTest<T extends Test | undefined>(): T;
//#endregion
export { AfterAllListener, AfterEachListener, AroundAllListener, AroundEachListener, BeforeAllListener, BeforeEachListener, CancelReason, FailureScreenshotArtifact, File, FileSpecification, Fixture, FixtureFn, FixtureOptions, Fixtures, ImportDuration, InferFixturesTypes, OnTestFailedHandler, OnTestFinishedHandler, Retry, RunMode, RuntimeContext, SequenceHooks, SequenceSetupFiles, SerializableRetry, Suite, SuiteAPI, SuiteCollector, SuiteFactory, SuiteHooks, SuiteOptions, Task, TaskBase, TaskCustomOptions, TaskEventPack, TaskHook, TaskMeta, TaskPopulated, TaskResult, TaskResultPack, TaskState, TaskUpdateEvent, Test, TestAPI, TestAnnotation, TestAnnotationArtifact, TestAnnotationLocation, TestArtifact, TestArtifactBase, TestArtifactLocation, TestArtifactRegistry, TestAttachment, TestContext, TestFunction, TestOptions, TestTagDefinition, TestTags, Use, VisualRegressionArtifact, VitestRunner, VitestRunnerConfig, VitestRunnerConstructor, VitestRunnerImportSource, afterAll, afterEach, aroundAll, aroundEach, beforeAll, beforeEach, publicCollect as collectTests, createTaskCollector, describe, getCurrentSuite, getCurrentTest, getFn, getHooks, it, onTestFailed, onTestFinished, recordArtifact, setFn, setHooks, startTests, suite, test, updateTask };