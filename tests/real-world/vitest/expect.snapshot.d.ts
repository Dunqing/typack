import { DiffOptions, diff, printDiffOrStringify } from "@vitest/utils/diff";
...
//#region tests/real-world/vitest/expect/jest-asymmetric-matchers.d.ts
...
//#endregion
//#region tests/real-world/vitest/expect/jest-matcher-utils.d.ts
...
//#endregion
//#region tests/real-world/vitest/expect/types.d.ts
...
//#endregion
//#region tests/real-world/vitest/expect/chai-style-assertions.d.ts
declare const ChaiStyleAssertions: ChaiPlugin;
//#endregion
//#region tests/real-world/vitest/expect/constants.d.ts
...
//#endregion
//#region tests/real-world/vitest/expect/custom-matchers.d.ts
declare const customMatchers: MatchersObject;
//#endregion
//#region tests/real-world/vitest/expect/jest-expect.d.ts
declare const JestChaiExpect: ChaiPlugin;
//#endregion
//#region tests/real-world/vitest/expect/jest-extend.d.ts
declare const JestExtend: ChaiPlugin;
//#endregion
//#region tests/real-world/vitest/expect/jest-utils.d.ts
...
//#endregion
//#region tests/real-world/vitest/expect/state.d.ts
...
//#endregion
//#region tests/real-world/vitest/expect/utils.d.ts
...
//#endregion
export { ASYMMETRIC_MATCHERS_OBJECT, Any, Anything, ArrayContaining, Assertion, AsymmetricMatcher, type AsymmetricMatcherInterface, AsymmetricMatchersContaining, AsyncExpectationResult, ChaiMockAssertion, ChaiPlugin, ChaiStyleAssertions, DeeplyAllowMatchers, DiffOptions, ExpectStatic, ExpectationResult, GLOBAL_EXPECT, JEST_MATCHERS_OBJECT, JestAssertion, JestAsymmetricMatchers, JestChaiExpect, JestExtend, MATCHERS_OBJECT, MatcherHintOptions, MatcherState, Matchers, MatchersObject, ObjectContaining, PromisifyAssertion, RawMatcherFn, SchemaMatching, StringContaining, StringMatching, SyncExpectationResult, Tester, TesterContext, addCustomEqualityTesters, arrayBufferEquality, chai, createAssertionMessage, customMatchers, equals, fnNameFor, generateToBeMessage, getObjectKeys, getObjectSubset, getState, hasAsymmetric, hasProperty, isA, isAsymmetric, isError, isImmutableUnorderedKeyed, isImmutableUnorderedSet, isStandardSchema, iterableEquality, pluralize, recordAsyncExpect, setState, sparseArrayEquality, subsetEquality, typeEquality, wrapAssertion };