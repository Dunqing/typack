...
type ModuleType$1 = "module" | "commonjs" | "json" | "wasm" | "addon";
/**
...
declare class BindingNormalizedOptions {
  ...
  get minify(): false | "dce-only" | MinifyOptions$3;
...
interface BindingViteDynamicImportVarsPluginConfig {
  ...
  resolver?: (id: string, importer: string) => MaybePromise$1<string | undefined>;
}
...
interface BindingViteTransformPluginConfig {
  ...
  jsxInject?: string;
  transformOptions?: TransformOptions$2;
  yarnPnp?: boolean;
}
...
type MinifyOptions$2 = Omit<MinifyOptions$3, "module" | "sourcemap">;
/** @inline */
...
interface OutputOptions {
  ...
  * @default false
  */
  minify?: boolean | "dce-only" | MinifyOptions$2;
  /**
...
interface NormalizedOutputOptions {
  ...
  minify: false | MinifyOptions$2 | "dce-only";
...
interface PluginContext extends MinimalPluginContext {
  ...
  */
  parse(input: string, options?: ParserOptions$1 | null): Program;
  /**
...
/** @inline @category Plugin APIs */
type TransformResult$2 = NullValue | string | (Omit<SourceDescription, "code"> & {
...
*/
declare function parse$1(filename: string, sourceText: string, options?: ParserOptions$1 | null): Promise<ParseResult$1>;
/**
...
*/
declare function parseSync$1(filename: string, sourceText: string, options?: ParserOptions$1 | null): ParseResult$1;
//#endregion
//#region src/utils/minify.d.ts
type MinifyOptions$1 = MinifyOptions$3 & {
  inputMap?: SourceMap$1;
};
/**
...
* @experimental
*/
declare function minify$1(filename: string, sourceText: string, options?: MinifyOptions$1 | null): Promise<MinifyResult$1>;
/**
* Minify synchronously.
*
* @experimental
*/
declare function minifySync$1(filename: string, sourceText: string, options?: MinifyOptions$1 | null): MinifyResult$1;
//#endregion
//#region src/utils/transform.d.ts
type TransformResult$1 = Omit<BindingEnhancedTransformResult, "errors" | "warnings"> & {
  errors: Error[];
...
* @experimental
*/
declare function transform$1(filename: string, sourceText: string, options?: BindingEnhancedTransformOptions | null, cache?: TsconfigCache$1 | null): Promise<TransformResult$1>;
/**
...
* @experimental
*/
declare function transformSync$1(filename: string, sourceText: string, options?: BindingEnhancedTransformOptions | null, cache?: TsconfigCache$1 | null): TransformResult$1;
//#endregion
//#region tests/real-world/rolldown/experimental-index.d.mts
...
//#endregion
export { type BindingClientHmrUpdate, BindingRebuildStrategy, DevEngine, type DevOptions, type DevWatchOptions, type IsolatedDeclarationsOptions, type IsolatedDeclarationsResult, MinifyOptions, MinifyResult, ParseResult, ParserOptions, type NapiResolveOptions as ResolveOptions, type ResolveResult, ResolverFactory, TransformOptions, TransformResult, TsconfigCache, TsconfigCompilerOptions, TsconfigRawOptions, createTokioRuntime, defineParallelPlugin, dev, viteDynamicImportVarsPlugin as dynamicImportVarsPlugin, freeExternalMemory, viteImportGlobPlugin as importGlobPlugin, isolatedDeclaration, isolatedDeclarationPlugin, isolatedDeclarationSync, memfs, minify, minifySync, moduleRunnerTransform, parse, parseSync, scan, transform, transformSync, viteAliasPlugin, viteBuildImportAnalysisPlugin, viteDynamicImportVarsPlugin, viteImportGlobPlugin, viteJsonPlugin, viteLoadFallbackPlugin, viteManifestPlugin, viteModulePreloadPolyfillPlugin, viteReactRefreshWrapperPlugin, viteReporterPlugin, viteResolvePlugin, viteTransformPlugin, viteWasmFallbackPlugin, viteWebWorkerPostPlugin };