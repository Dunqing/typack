...
//#endregion
export { IsolatedDeclarationsResult as A, SourceMap as B, BindingViteReactRefreshWrapperPluginConfig as C, BindingWatcherBundler as D, BindingViteTransformPluginConfig as E, ParseResult as F, isolatedDeclarationSync as G, TsconfigCache as H, ParserOptions as I, moduleRunnerTransform as K, PreRenderedChunk as L, MinifyOptions as M, MinifyResult as N, ExternalMemoryStatus as O, NapiResolveOptions as P, ResolveResult as R, BindingViteModulePreloadPolyfillPluginConfig as S, BindingViteResolvePluginConfig as T, createTokioRuntime as U, TransformOptions as V, isolatedDeclaration as W, BindingViteBuildImportAnalysisPluginConfig as _, BindingEnhancedTransformResult as a, BindingViteJsonPluginConfig as b, BindingIsolatedDeclarationPluginConfig as c, BindingRebuildStrategy as d, BindingRenderedChunk as f, BindingTsconfigRawOptions as g, BindingTsconfigCompilerOptions as h, BindingEnhancedTransformOptions as i, JsxOptions as j, IsolatedDeclarationsOptions as k, BindingMagicString as l, BindingTransformHookExtraArgs as m, BindingBundleState as n, BindingEsmExternalRequirePluginConfig as o, BindingReplacePluginConfig as p, BindingClientHmrUpdate as r, BindingHookResolveIdExtraArgs as s, BindingBuiltinPluginName as t, BindingPluginContextResolveOptions as u, BindingViteDynamicImportVarsPluginConfig as v, BindingViteReporterPluginConfig as w, BindingViteManifestPluginConfig as x, BindingViteImportGlobPluginConfig as y, ResolverFactory as z };