import type { ComponentInjectOptions, ComponentOptions, ComponentOptionsBase, ComponentOptionsMixin, ComponentProvideOptions, ComputedOptions, MethodOptions, RenderFunction } from './componentOptions';
import type { AllowedComponentProps, Component, ComponentCustomProps, GlobalComponents, GlobalDirectives, SetupContext } from './component';
import type { ComponentObjectPropsOptions, ComponentPropsOptions, ExtractDefaultPropTypes, ExtractPropTypes } from './componentProps';
import type { EmitsOptions, EmitsToProps, TypeEmitsToOptions } from './componentEmits';
import { type IsKeyValues } from '@vue/shared';
import type { VNodeProps } from './vnode';
import type { ComponentPublicInstanceConstructor, CreateComponentPublicInstanceWithMixins } from './componentPublicInstance';
