...
//#region tests/real-world/core/runtime-dom/nodeOps.d.ts
declare const nodeOps: Omit<RendererOptions<Node, Element>, "patchProp">;
//#endregion
//#region tests/real-world/core/runtime-dom/patchProp.d.ts
type DOMRendererOptions = RendererOptions<Node, Element>;
declare const patchProp: DOMRendererOptions["patchProp"];
//#endregion
//#region tests/real-world/core/runtime-dom/components/Transition.d.ts
...
//#endregion
//#region tests/real-world/core/runtime-dom/components/TransitionGroup.d.ts
...
//#endregion
//#region tests/real-world/core/runtime-dom/directives/vShow.d.ts
...
//#endregion
//#region tests/real-world/core/runtime-dom/directives/vOn.d.ts
...
//#endregion
//#region tests/real-world/core/runtime-dom/directives/vModel.d.ts
...
//#endregion
//#region tests/real-world/core/runtime-dom/apiCustomElement.d.ts
...
declare function defineCustomElement<
  Props,
  RawBindings = object
>(setup: (props: Props, ctx: SetupContext) => RawBindings | RenderFunction, options?: Pick<ComponentOptions, "name" | "inheritAttrs" | "emits"> & CustomElementOptions & {
  props?: (keyof Props)[];
...
declare function defineCustomElement<
  ...
  InferredProps = string extends PropsKeys ? ComponentObjectPropsOptions extends RuntimePropsOptions ? {} : ExtractPropTypes<RuntimePropsOptions> : { [key in PropsKeys]? : any },
...
declare class VueElement extends BaseClass implements ComponentCustomElementInterface {
  ...
  */
  ...
  private _ob?;
  private _slots?;
  constructor(_def: InnerComponentDef, _props?: Record<string, any>, _createApp?: CreateAppFunction<Element>);
...
declare function useHost(caller?: string): VueElement | null;
/**
...
//#endregion
//#region tests/real-world/core/runtime-dom/helpers/useCssModule.d.ts
declare function useCssModule(name?: string): Record<string, string>;
//#endregion
//#region tests/real-world/core/runtime-dom/helpers/useCssVars.d.ts
/**
...
//#endregion
//#region tests/real-world/core/runtime-dom/jsx.d.ts
...
//#endregion
//#region tests/real-world/core/runtime-dom.d.ts
/**
