//#region tests/rolldown-plugin-dts/shadowing/exports.d.ts
declare class GenericKlass<
  A = any,
  B = A
> {
  a: A;
...
declare function genericFunction<
  E = any,
  F = E
>(e: E): F;
...
interface GenericExtends<
  M = any,
  N = M
> extends GenericInterface<M, N> {}
//#endregion
